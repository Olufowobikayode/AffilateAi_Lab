...
exports.processScheduledPosts = exports.schedulePost = void 0;
...
const scheduledPostsQueue = new bullmq_1.Queue('scheduledPosts', {
    connection: { host: process.env.REDIS_HOST || 'localhost', port: parseInt(process.env.REDIS_PORT || '6379') },
});
const getOptimalPostingTime = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const insights = yield (0, facebookService_1.getPageInsights)(pageId, accessToken, ['page_post_engagements']);
...
const schedulePost = (post) => __awaiter(void 0, void 0, void 0, function* () {
    const delay = yield getOptimalPostingTime();
    yield scheduledPostsQueue.add('publishPost', post, { delay });
...
const processScheduledPosts = (post) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, facebookService_1.postToFacebookPage)(pageId, accessToken, post.content, post.imageUrl);
...
exports.processScheduledPosts = processScheduledPosts;
